...
namespace avcUnitTest
{
    ...
    public class UnitTest1
    {
        ...
        string pw = "softcore";
        string path = @"/home/softcore/bin/zjxt";
        [TestMethod]
        public void TestMethod8()
        {
            myRemoteLib_v1.FtpWeb fw = new FtpWeb(ip, path, user, pw);
            bool b = fw.Download("d:", "c3.xml");
            Console.WriteLine(b.ToString());
            if(!b)
                Console.WriteLine(fw.errMsg);
        }
        ...
        {
            myRemoteLib_v1.FtpWeb fw = new FtpWeb(ip, path, user, pw);
            bool b = fw.Delete("test.txt");//fw.Delete("c3p0-config-zjxt2.xml");
            Console.WriteLine(b.ToString());
            if (!b)
                Console.WriteLine(fw.errMsg);
        }
        ...
        {
            myRemoteLib_v1.FtpWeb fw = new FtpWeb("10.1.1.22", path, user, pw);
            bool b = fw.ftpPing();
            Console.WriteLine(b.ToString());
            if (!b)
                Console.WriteLine(fw.errMsg);
