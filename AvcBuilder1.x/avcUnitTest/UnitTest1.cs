...
//        }
        ...
        {
            myRemoteLib_v1.FtpWeb fw = new FtpWeb("192.168.0.230", "/home/softcore/bin/zjxt", "moxa", "moxa");
            bool b = fw.Download("d:", "c3p0-config-zjxt2.xml");
        ...
        {
            myRemoteLib_v1.FtpWeb fw = new FtpWeb("192.168.0.230", "/home/softcore/bin/zjxt", "moxa", "moxa");
            bool b = fw.Delete("zjxt.log");//fw.Delete("c3p0-config-zjxt2.xml");
            Console.WriteLine(b.ToString());
        }
        ...
        {
            myRemoteLib_v1.FtpWeb fw = new FtpWeb("192.168.0.230", "/home/softcore/bin/zjxt", "softcore", "softcore");
            bool b = fw.Upload(@"d:\c3.xml");
            Console.WriteLine(b.ToString());
        }
